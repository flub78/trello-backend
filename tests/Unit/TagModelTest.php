...
class TagModelTest extends TestCase
{
    ...
    public function testCRUD(): void
    {
        ...
        if ($this->log) {
            Log::info("TagModelTest.testCRUD initial_count: $initial_count");
        }
        ...
        if ($this->log) {
            Log::info("TagModelTest.testCRUD final_count: $final_count");
        }
