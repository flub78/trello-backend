 ...
 */
class TaskCommentModelTest extends TestCase
{
    protected $log = true;
    ...
    {
        $initial_count = TaskComment::count();
        if ($this->log) {
            Log::info("TaskCommentModelTest.testCRUD initial_count: $initial_count");
        }
        ...
        if ($diff > 0) {
            ...
            $found = TaskComment::find($elt3_key);
