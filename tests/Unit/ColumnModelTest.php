...
class ColumnModelTest extends TestCase
{
    ...
    {
        $initial_count = Column::count();
        if ($this->log) {
            Log::info("ColumnModelTest.testCRUD initial_count: $initial_count");
        }

        // Create some elements
        $elt1 = Column::factory()->make();
        ...
        $diff = 0;
        $high_variability_fields = ["name", "tasks"];
