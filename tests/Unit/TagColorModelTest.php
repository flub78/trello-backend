...
class TagColorModelTest extends TestCase
{
    ...
    public function testCRUD(): void
    {
        ...
        if ($this->log) {
            Log::info("TagColorModelTest.testCRUD initial_count: $initial_count");
        }
        ...
        if ($this->log) {
            Log::info("TagColorModelTest.testCRUD final_count: $final_count");
        }
