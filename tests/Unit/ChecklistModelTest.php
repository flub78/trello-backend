...
class ChecklistModelTest extends TestCase
{
    ...
    {
        $initial_count = Checklist::count();
        if ($this->log) {
            Log::info("ChecklistModelTest.testCRUD initial_count: $initial_count");
        }

        // Create some elements
        $elt1 = Checklist::factory()->make();
        ...
        $diff = 0;
        $high_variability_fields = ["name", "description"];
