...
class ChecklistItemModelTest extends TestCase
{
    ...
    public function testCRUD(): void
    {
        ...
        $elt1 = ChecklistItem::factory()->make();
        ...
        $elt3 = ChecklistItem::factory()->make();
        ...
        $diff = 0;
        $high_variability_fields = ["description"];
        ...
        if ($diff > 0) {
            ...
            $found = ChecklistItem::find($elt3_key);
        ...
        $final_count = ChecklistItem::count();
