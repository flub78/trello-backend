...
class TagColorApiControllerTest extends TestCase
{
    ...
    public function test_api_crud(): void
    {
        ...
        Log::info("TagColorControllerTest.test_api_crud initial_count: $initial_count");
