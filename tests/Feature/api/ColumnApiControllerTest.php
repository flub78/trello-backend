...
class ColumnApiControllerTest extends TestCase
{
    ...
    public function test_api_crud(): void
    {
        ...
        Log::info("ColumnControllerTest.test_api_crud initial_count: $initial_count");
